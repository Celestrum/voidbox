...
const uploader = async (ev: { files: File | File[] }) => {
...
<template>
    <main
        ...
        class="w-screen h-screen flex flex-col justify-center items-center dark:bg-slate-500 bg-slate-200"
    >
        <h1 class="py-12 text-4xl font-bold text-center text-gray-800">
            upload yer files!
        </h1>
                ...
                :pt="{
                    ...
                    chooseButton: {
                        class: [
                            ...
                            'hover:ring-offset-2',
                            'hover:ring-offset-gray-100 dark:hover:ring-offset-gray-700',
    ...
    <main
        v-else
        class="w-screen h-screen flex flex-col justify-center items-center bg-slate-200 dark:bg-slate-700"
    >
        <h1 class="py-12 text-4xl font-bold text-center text-gray-800">
            behold yer response=
        </h1>
        <div
            class="card flex flex-col items-center justify-center p-4 rounded-md bg-gray-800 ring-1 min-w-[50%]"
        >
            <img
                class="aspect-auto drop-shadow-sm shadow-purple-400 dark:text-white transition-all duration-500 ease-in-out max-w-5xl"
                :src="showResult"
                alt="result"
            />
            <button
